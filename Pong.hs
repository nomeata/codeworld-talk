...
drawPong mbP PongState{..} = mconcat
    ...
    , colored blue $ translated    9.5 (-9.5) (text (showt scoreB))
    ]
...
initPong gen = PongState gen 0 0 0 0 0 0 (0,maxY-ballRadius) (initSpeed, 0.8*initSpeed)
